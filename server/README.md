...
- `DB_NAME` - имя существующей базы данных MySQL
...
4. **Важно**: Убедитесь, что база данных MySQL уже создана и доступна. Приложение только подключается к существующей базе данных и не создает новую.
...
- **Важно**: Приложение подключается к существующей базе данных. Таблицы должны быть созданы заранее или через миграции
